...
Sprites *sprites_create() {
    ...
    Rectangle tank_track_r = {12, 48, TANK_TRACK_PIXELWIDTH, TANK_TRACK_PIXELHEIGHT};
    Rectangle tank_hull_r = {3, 34, TANK_HULL_PIXELWIDTH, TANK_HULL_PIXELHEIGHT};
    Rectangle tank_turret_r = {2, 17, TANK_TURRET_PIXELWIDTH, TANK_TURRET_PIXELHEIGHT};
    Rectangle tank_barrel_r = {11, 19, TANK_BARREL_PIXELWIDTH, TANK_BARREL_PIXELHEIGHT};
    Rectangle bullet_r = {11, 25, BULLET_PIXELWIDTH, BULLET_PIXELHEIGHT};
    Rectangle exporb_r = {3, 25, EXPORB_PIXELWIDTH, EXPORB_PIXELHEIGHT};
    Rectangle spider_r = {16, 17, SPIDER_PIXELWIDTH, SPIDER_PIXELHEIGHT};
